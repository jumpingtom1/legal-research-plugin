...
- **`mcp__plugin_legal_research_courtlistener__get_case_text`**: Retrieves the full text of a court opinion by cluster_id or opinion_id. Returns up to 300,000 characters; longer opinions are truncated with a link to the full version.
